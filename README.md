...
The dampening modifications tune the sound of the DT770 without changing it completely. Overall, I would say this mod changes the DT770's signature "V-shaped" to a more linear experience. The high-end is pushed back, allowing the mid-range to appear to be more foward, while the low-end remains largely unchanged. See the "Pad Rolling" section for more on this.
...
**WARNING USE LOW HEAT:** The three terminals are soldered directly onto the drivers. If you apply too much heat and break one loose--just throw the headphones away! If you've never used a desoldering wick, check YouTube.
